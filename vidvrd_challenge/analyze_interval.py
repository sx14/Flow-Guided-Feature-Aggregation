...
print('ImageNet VID AVG frame num: %.2f' % (sum(video_frame_ns)*1.0/len(video_frame_ns)/15))
...
print('VidOR VID AVG frame num: %.2f' % (sum(video_frame_ns)*1.0/len(video_frame_ns)/15))
